...
while running:
    ...
    longest_line = max(b_length, c_length)
    point1 = (10,500)
    point2 = (10 + longest_line, 500)
    # getting point3:
    point3_angle = alpha - 90
    point3_angle_rad = math.radians(point3_angle)
    x_point3 = point1[0] - b_length * math.cos(point3_angle_rad)
    y_point3 = point1[1] + b_length * math.sin(point3_angle_rad) 
    point3 = (x_point3, y_point3)
    
    print(x_point3, y_point3, math.degrees(math.atan2(y_point3 - point1[1], x_point3 - point1[0])))
    
    print(y_point3, point1[1], point3_angle_rad)
    
    pygame.draw.line(win, RED, point1, point2, 5)
    pygame.draw.line(win, GREEN, point3, point1, 5)
    pygame.draw.line(win, BLUE, point2, point3, 5)
    ...
    a_text_surface = font.render(alpha_text + a_user_text, True, BLACK)
